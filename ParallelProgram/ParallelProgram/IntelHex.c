...
{
	char* buffer = {':', 0x10, 0x00, 0x00, 0x00, 0x14, 0xC0, 0x19, 0xC0, 0x18, 0xC0, 0x17, 0xC0, 0x16, 0xC0, 0x15, 0xC0, 0x14, 0xC0, 0x13, 0xC0, 0x42,
					':', 0x10, 0x00, 0x10, 0x00, 0x12, 0xC0, 0x11, 0xC0, 0x10, 0xC0, 0x0F, 0xC0, 0x0E, 0xC0, 0x0D, 0xC0, 0x0C, 0xC0, 0x0B, 0xC0, 0x6C
					':', 0x00, 0x00, 0x00, 0x01, 0xFF}; 
					
	RAMWrite(buffer, HEX_FILE_ADDRESS, strlen(buffer));
